                ...
                <div className="w-full flex bg-white shadow-lg overflow-hidden min-h-[600px]">
                    ...
                    <div className="w-1/2 bg-white p-12 text-white">
                        ...
                        <div className="flex justify-center mb-10">
                            <button onClick={ () => setSelectedRole("siswa")} className={`px-6 py-2 ${selectedRole === "siswa" ? "bg-[#D1AE5A]" : "bg-[#1D538F]"} text-[#e3e3e3] font-semibold rounded-l-xl text-md min-w-60 min-h-16 hover:outline-2 `}>
                                Siswa
                            </button>
                            <button onClick={ () => setSelectedRole("guru")} className={`px-6 py-2 ${selectedRole === "guru" ? "bg-[#D1AE5A]" : "bg-[#1D538F]"} text-[#e3e3e3] font-semibold rounded-r-xl text-md min-w-60 min-h-16`}>
                                Guru
                            </button>
                        </div>
                        ...
                        <form onSubmit={submit} className="flex flex-col items-center">
                            ...
                            <div className='bg-[#1D538F] w-full p-10 rounded-xl mb-10'>
                                ...
                                <div className="text-center mt-12 text-[#A6BCD0]">
                                    Belum punya akun? <Link href="/register" className="text-white hover:underline">Daftar Sekarang</Link>
                                </div>
                            </div>
